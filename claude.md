...
- **NEVER** manually edit files in `packages/api-client/` - this package is auto-generated
...
- **NEVER** create manual HTTP services - use auto-generated `@ai-nx-starter/api-client`
- **NEVER** manually edit `packages/api-client/` - auto-generated by `npm run gen-api-client`
