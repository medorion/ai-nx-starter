...
/**
 * Extract imports from a source file that match @medorion/types
 * @param sourceFile - The source file to analyze
 * @returns Set of imported type names from @medorion/types
 */
function extractTypesImports(sourceFile: any): Set<string> {
  ...
  imports.forEach((importDecl: any) => {
    ...
    if (moduleSpecifier === '@medorion/types') {
...
`;
  ...
  // Add imports from @medorion/types
  code += `import { ${Array.from(allImportNames).join(', ')} } from '@medorion/types';
`;
...
`;
  code += ` * Auto-generated by gen-api-client.ts
`;
  code += ` */
`;
  code += `@Injectable({
