...
import { IdNameDto, Role, ClientUserDto, UserInSessionDto, UsersByChannelDto } from '@medorion/types';
...
export class UsersService {
  ...
  public async getUsers(orgCode: string, session: SessionInfo): Promise<ClientUserDto[]> {
