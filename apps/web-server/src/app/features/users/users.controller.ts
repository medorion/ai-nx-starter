...
import { ORG_CODE_PATH_PARAM, ResetPasswordDto, Role, ClientUserDto } from '@medorion/types';
...
export class UsersController {
  ...
  public getUsers(@Param(`${ORG_CODE_PATH_PARAM}`) orgCode: string, @Session() session: SessionInfo): Promise<ClientUserDto[]> {
