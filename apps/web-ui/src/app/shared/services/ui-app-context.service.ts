...
import { UiAppContextDto, UserDto, IdCodeNameDto, IdNameDto } from '@medorion/types';
...
export class UIAppContextService {
  ...
  public readonly currentUser$: Observable<UserDto | null> = this.uiAppContext$.pipe(map((context) => context?.currentUser || null));
