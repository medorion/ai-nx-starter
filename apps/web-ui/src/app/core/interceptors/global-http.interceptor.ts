    ...
    switch (error.status) {
      ...
      case ErrorStatusCode.AppWarning:
        this.eventBus.publishAppWarningHttp({
          ...
          userMessage:
            error.error?.message ||
            "A warning occurred while processing your request.",
        });
        break;
      ...
      case ErrorStatusCode.AppError:
        this.eventBus.publishAppErrorHttp({
          ...
          userMessage:
            error.error?.message ||
            "An application error occurred. Please try again or contact support.",
        });
        break;
      ...
      default:
        ...
        this.eventBus.publishHttpError({
          ...
          userMessage:
            error.statusText ||
            `HTTP ${error.status}: An error occurred while processing your request.`,
        });
        break;
    }
  }
