...
export class EventBusService {
  ...
  ): Observable<EventPayload<UserLoggedInPayload>> {
    return this.pubSubService.subscribe<UserLoggedInPayload>(
      CommonEvents.USER_LOGGED_IN,
      config
    );
  }
  ...
  onUserLoggedOut(config?: SubscriptionConfig): Observable<EventPayload<null>> {
    return this.pubSubService.subscribe<null>(
      CommonEvents.USER_LOGGED_OUT,
      config
    );
  }
  ...
  onSessionExpired(
    config?: SubscriptionConfig
  ): Observable<EventPayload<null>> {
    return this.pubSubService.subscribe<null>(
      CommonEvents.USER_SESSION_EXPIRED,
      config
    );
  }
  ...
  onRouteChanged(
    config?: SubscriptionConfig
  ): Observable<EventPayload<RouteChangedPayload>> {
    return this.pubSubService.subscribe<RouteChangedPayload>(
      CommonEvents.ROUTE_CHANGED,
      config
    );
  }
  ...
  onPageLoaded(
    config?: SubscriptionConfig
  ): Observable<EventPayload<{ url: string }>> {
    return this.pubSubService.subscribe<{ url: string }>(
      CommonEvents.PAGE_LOADED,
      config
    );
  }
  ...
  onThemeChanged(
    config?: SubscriptionConfig
  ): Observable<EventPayload<ThemeChangedPayload>> {
    return this.pubSubService.subscribe<ThemeChangedPayload>(
      CommonEvents.THEME_CHANGED,
      config
    );
  }
  ...
  onSidebarToggled(
    config?: SubscriptionConfig
  ): Observable<EventPayload<{ isOpen: boolean }>> {
    return this.pubSubService.subscribe<{ isOpen: boolean }>(
      CommonEvents.SIDEBAR_TOGGLED,
      config
    );
  }
  ...
  onModalOpened(
    config?: SubscriptionConfig
  ): Observable<EventPayload<{ modalId: string; data?: any }>> {
    return this.pubSubService.subscribe<{ modalId: string; data?: any }>(
      CommonEvents.MODAL_OPENED,
      config
    );
  }
  ...
  onModalClosed(
    config?: SubscriptionConfig
  ): Observable<EventPayload<{ modalId: string; result?: any }>> {
    return this.pubSubService.subscribe<{ modalId: string; result?: any }>(
      CommonEvents.MODAL_CLOSED,
      config
    );
  }
  ...
  onDataLoaded<T = any>(
    config?: SubscriptionConfig
  ): Observable<EventPayload<DataOperationPayload<T>>> {
    return this.pubSubService.subscribe<DataOperationPayload<T>>(
      CommonEvents.DATA_LOADED,
      config
    );
  }
  ...
  onDataDeleted<T = any>(
    ...
    return this.pubSubService.subscribe<DataOperationPayload<T>>(
      CommonEvents.DATA_DELETED,
      config
    );
  }

  publishDataError(error: {
    message: string;
    code?: string;
    details?: any;
  }): void {
  ...
  onDataError(
    ...
    EventPayload<{ message: string; code?: string; details?: any }>
  > {
  ...
  publishNotification(payload: NotificationPayload): void {
    this.pubSubService.publish(
      CommonEvents.NOTIFICATION_SHOW,
      payload,
      "notification"
    );
  }
  ...
  onNotification(
    config?: SubscriptionConfig
  ): Observable<EventPayload<NotificationPayload>> {
    return this.pubSubService.subscribe<NotificationPayload>(
      CommonEvents.NOTIFICATION_SHOW,
      config
    );
  }
  ...
  publishNotificationHide(notificationId: string): void {
    this.pubSubService.publish(
      CommonEvents.NOTIFICATION_HIDE,
      { id: notificationId },
      "notification"
    );
  }
  ...
  onNotificationHide(
    config?: SubscriptionConfig
  ): Observable<EventPayload<{ id: string }>> {
    return this.pubSubService.subscribe<{ id: string }>(
      CommonEvents.NOTIFICATION_HIDE,
      config
    );
  }
  ...
  onFormSubmitted(
    config?: SubscriptionConfig
  ): Observable<EventPayload<FormEventPayload>> {
    return this.pubSubService.subscribe<FormEventPayload>(
      CommonEvents.FORM_SUBMITTED,
      config
    );
  }
  ...
  onFormReset(
    config?: SubscriptionConfig
  ): Observable<EventPayload<{ formId: string }>> {
    return this.pubSubService.subscribe<{ formId: string }>(
      CommonEvents.FORM_RESET,
      config
    );
  }
  ...
  publishFormValidationError(payload: FormEventPayload): void {
    this.pubSubService.publish(
      CommonEvents.FORM_VALIDATION_ERROR,
      payload,
      "form"
    );
  }
  ...
  onAppInitialized(config?: SubscriptionConfig): Observable<EventPayload<any>> {
    return this.pubSubService.subscribe<any>(
      CommonEvents.APP_INITIALIZED,
      config
    );
  }
  ...
  onSessionExpiredHttp(
    config?: SubscriptionConfig
  ): Observable<EventPayload<SessionExpiredPayload>> {
    return this.pubSubService.subscribe<SessionExpiredPayload>(
  ...
  onAppErrorHttp(
    config?: SubscriptionConfig
  ): Observable<EventPayload<AppErrorPayload>> {
    return this.pubSubService.subscribe<AppErrorPayload>(
      "http:app-error",
      config
    );
  }
  ...
  onAppWarningHttp(
    config?: SubscriptionConfig
  ): Observable<EventPayload<AppWarningPayload>> {
    return this.pubSubService.subscribe<AppWarningPayload>(
      "http:app-warning",
      config
    );
  }
  ...
  onConcurrencyExceptionHttp(
    config?: SubscriptionConfig
  ): Observable<EventPayload<ConcurrencyExceptionPayload>> {
    return this.pubSubService.subscribe<ConcurrencyExceptionPayload>(
      "http:concurrency-exception",
      config
    );
  }
  ...
  onHttpError(
    config?: SubscriptionConfig
  ): Observable<EventPayload<HttpErrorPayload>> {
